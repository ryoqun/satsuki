...
class IMApp:
  def __init__(self, exec_by_ibus):
    self.__component = ibus.Component("org.freedesktop.IBus.satsuki",
                                      "satuki Python Component",
                                      "0.1.0",
                                      "GPL",
                                      "Peng Huang <shawn.p.huang@gmail.com>")
    self.__component.add_engine("satsuki",
                                "satsuki",
                                "StATefUl KIboard",
                                "ja",
                                "GPL",
                                "Ryo Onodera <ryoqun@gmail.com>",
                                "",
                                "ja")
    ...
    if exec_by_ibus:
      self.__bus.request_name("org.freedesktop.IBus.satsuki", 0)
    else:
